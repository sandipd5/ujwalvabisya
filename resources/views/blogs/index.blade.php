...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div>
      <center>
      <a href="{{route('blogs.create')}}" class="btn btn-lg btn-success">
        create new blogs/news
      </a>
      </center>  
    </div>
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ substr($blogs->body,0,100) }}</td>
          <td><a href="{{ route('blogs.show',$blogs->id) }}" class="btn btn-success">view</a></td>
