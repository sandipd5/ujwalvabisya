...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <!-- Navigation-->
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"  id="mainNav">
    <a class="navbar-brand" href="index.html">ujwal vabisya</a>
  ...
  <div class="content-wrapper">
    <div>
      <center>
      <a href="{{route('videos.create')}}" class="btn btn-lg btn-success">
        upload new Video
      </a>
      </center>  
    </div>
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><iframe width="560" height="315" src="{{ $videos->video  }}" frameborder="0" allowfullscreen></iframe></td>
          <td> 
